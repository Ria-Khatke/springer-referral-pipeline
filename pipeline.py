...
# ============================================================
# Steps:
#   1. Load       — read all 7 CSV files
#   2. Clean      — fix types, parse dates, extract reward days
#   3. Process    — timezone conversion, joins, source category
#   4. Fraud      — is_business_logic_valid flag
#   5. Output     — save 46-row CSV report
# ============================================================
